...
public class ContactService {
    ...
    @Value("${app.admin.email:jojogroceries@gmail.com}")
    ...
    public void sendContactMessage(String name, String email, String subject, String message) {
        try {
            ...
            emailService.sendText(
                    email,
                    "Thank you for contacting JOJO Groceries",
                    "Dear " + name + ",\n\n" +
                            "Thank you for contacting JOJO Groceries. We have received your message and will get back to you as soon as possible.\n\n" +
                            "Your message:\n" +
                            "Subject: " + subject + "\n" +
                            "Message: " + message + "\n\n" +
                            "Best regards,\n" +
