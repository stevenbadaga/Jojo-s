      ...
      <section className="bg-gradient-to-br from-[#002524] via-[#003834] to-[#004D47] text-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
          ...
          <p className="text-gray-200 text-base sm:text-xl max-w-3xl mx-auto leading-relaxed font-medium">
            MarketMet brings local farm harvests, crisp vegetables, artisan bread, and cold dairy directly to your door in as fast as 30 minutes. Fresh Groceries to Your Door.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 sm:p-12 border border-gray-200/90 dark:border-gray-800 shadow-xl grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 space-y-5">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed font-medium">
              Founded with a mission to empower local Rwandan agriculture, MarketMet bridges the gap between regional organic farmers and busy urban households.
            </p>

            <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed font-medium">
              When you order with MarketMet, a trained personal shopper selects each item with care—picking the firmest avocados, sweetest strawberries, and freshest milk—before delivering them straight to your kitchen.
            </p>
