      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 font-medium">
            Everything you need to know about MarketMet Express delivery windows, free delivery threshold, and temperature-controlled vans.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
              Delivered straight from MarketMet Kigali Hub to your door in as fast as 30 minutes.
            </p>
