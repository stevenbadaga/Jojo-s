  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: 'How fast is JOJO Express delivery?',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'What is the JOJO 100% Freshness Guarantee?',
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 font-medium">
            Everything you need to know about JOJO Express delivery, organic freshness guarantee, and WhatsApp checkout.
          </p>
        </div>
